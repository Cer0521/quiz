...
from app.routers import auth, quizzes, attempts, subscriptions, grading, dashboard, flashcards
...
app = FastAPI(title="StudyTime API", version="1.0.0", lifespan=lifespan)
...
async def global_exception_handler(request: Request, exc: Exception):
    """Catch-all handler so unhandled errors return JSON instead of HTML."""
